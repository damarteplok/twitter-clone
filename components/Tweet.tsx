...
function Tweet({ tweet }: Props) {
  ...
  return (
    <div className="flex flex-col border-y border-gray-100 p-3">
      ...
      {commentBoxVisible && (
          <form className='mt-3 flex space-x-3' onSubmit={handleSubmit}>
              <input value={input} onChange={e => setInput(e.target.value)} className='flex-1 rounded-lg bg-gray-100 outline-none' type="text" placeholder='Write a comment...' />
